...
@section('content')
    <a class="btn btn-outline-danger text-white" style="margin:20px" href="/avatar">
        <div class="d-flex align-items-center">
            <ion-icon name="chevron-back-outline"></ion-icon> @lang('giveAvatar.back')
        </div>
    </a>
    <div class="container" style="margin-top:10px">
        <h3 class="text-white text-center">@lang('giveAvatar.give')</h3>
        ...
        <form action="/giveAvatar" method="post">
            ...
            <div class="d-flex flex-column align-items-center" style="margin-top:20px">
                <strong class="text-white">@lang('giveAvatar.giveTo'):</strong>
                ...
                <button class="btn btn-primary" style="width:40%;margin-top:20px">@lang('giveAvatar.give')!</button>
            </div>
        </form>
    </div>
@endsection
